...
const AddorderData = ({onCloseOrder}:PollModalProps) => {
    ...
    const postProduct = async (data: { note: string; usedQuantity: string;productId:string;label:string }) => {
        try {
            const response = await API.post("product/by-seller", data);
    ...
    return (
        ...
        <div className="relative bg-white p-8 rounded-lg shadow-lg w-[400px]">
            ...
            <h1 className="mt-10 mb-1 text-black font-bold items-center">Add Order</h1>
            <p className="mt-10 mb-1 text-black">Product ID</p>
            <input
            ...
            <p className="mt-10 mb-1 text-black">Order Name</p>
            <input
                className="rounded-md p-3 w-full outline-none border border-[#D1D5DB] text-black"
                type="text"
                name="note"
            ...
            <p className="mt-10 mb-1 text-black">Label</p>
            <input
                className="rounded-md p-3 w-full outline-none border border-[#D1D5DB] text-black"
                type="text"
                name="label"
            ...
            <p className="mt-4 mb-1 text-black">Used Quantity</p>
            <input
                className="rounded-md p-3 w-full outline-none border border-[#D1D5DB] text-black"
                type="text"
                name="totalQuantity"
